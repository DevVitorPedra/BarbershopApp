...
public class ClienteDAO {
    ...
    public List<Cliente> obterTodos() {
        ...
        Cursor cursor = banco.query("cliente", new String[]{"id", "nome", "data", "telefone", "bairro", "lazer", "obs", "topete", "topo", "lateral", "textura", "encaixe", "acabamento", "taper", "observacao", "barbacomp","barbalat","bigode","linhabochecha","linhagogo","detalhes"}, null, null, null, null, null);
        ...
        while (cursor.moveToNext()) {
            ...
            a.setBrbComp(cursor.getString(15));
            a.setBrbLat(cursor.getString(16));
            a.setBrbBigode(cursor.getString(17));
            a.setBrbLBochecha(cursor.getString(18));
            a.setBrbLGogo(cursor.getString(19));
            a.setBrbDetalhes(cursor.getString(20));
            clientes.add(a);
    ...
    public long inserirBarba(Cliente cliente) {
        ContentValues contentValues = new ContentValues();
        contentValues.put("data", cliente.getData());
        contentValues.put("barbacomp", cliente.getBrbComp());
        contentValues.put("barbalat", cliente.getBrbLat());
        contentValues.put("bigode", cliente.getBrbBigode());
        contentValues.put("linhabochecha", cliente.getBrbLBochecha());
        contentValues.put("linhagogo", cliente.getBrbLGogo());
        contentValues.put("detalhes", cliente.getBrbDetalhes());
        return banco.insert("cliente", null, contentValues);

    }

    public long atualizarBarba(Cliente cliente) {
        ContentValues contentValues = new ContentValues();
        contentValues.put("data", cliente.getData());
        contentValues.put("barbacomp", cliente.getBrbComp());
        contentValues.put("barbalat", cliente.getBrbLat());
        ...
        contentValues.put("linhagogo", cliente.getBrbLGogo());
        contentValues.put("detalhes", cliente.getBrbDetalhes());
        return banco.update("cliente", contentValues, "nome = ?", new String[]{cliente.getNome()});
...
/*
a.setBrbComp(cursor.getString(16));
            a.setBrbLat(cursor.getString(17));
            a.setBrbBigode(cursor.getString(18));
            a.setBrbLBochecha(cursor.getString(19));
            a.setBrbLGogo(cursor.getString(20));
            a.setBrbDetalhes(cursor.getString(21));


            "barbacomp","barbalat","bigode","linhabochecha","linhagogo","detalhes"
 */
